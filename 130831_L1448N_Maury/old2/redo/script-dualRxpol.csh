...
uvaver vis=3c84_"$suffix".$sb out=combined_"$suffix".$sb 
end
#goto terminate
...
POLCAL:
foreach sb(lsb usb)
gpcal vis=$polcal"_""$dt"_"$suffix".$sb  refant=4 options=circular,qusolve interval=10 flux=6.5 select='time(14:00,16:00)'
end
goto terminate
