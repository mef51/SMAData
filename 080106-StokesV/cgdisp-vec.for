...
c
     ...
     +  veccolo, boxcolo, ovrcolo, bemcolo
...
c
     ...
     +  hs, firstimage, blacklab, veccolo, boxcolo, ovrcolo, bemcolo)
c
...
c
     ...
     +             ovrcol, bemcol, blacklab, veccolo, boxcolo, 
     +             ovrcolo, bemcolo)
c
c Init OFM routines 
c
...
c
     ...
     -     fs, hs, firstimage, blacklab, veccolo, boxcolo, ovrcolo, 
     -     bemcolo)
c-----------------------------------------------------------------------
...
c
      ...
      integer veccolo, boxcolo, bemcolo, ovrcolo
...
c
      ...
      call keyi ('veccolo', veccolo, -1)
      call keyi ('boxcolo', boxcolo, -1)
      call keyi ('bemcolo', bemcolo, -1)
      call keyi ('ovrcolo', ovrcolo, -1)
c
...
c-----------------------------------------------------------------------
      ...
      integer veccolo, boxcolo, ovrcolo, bemcolo
      logical blacklab
c-----------------------------------------------------------------------
c
c Labels first
...
c
      ...
      if (veccolo.gt.-1) veccol = veccolo
c
c Now boxes
c
      boxcol = 6
      if (boxcolo.gt.-1) boxcol = boxcolo
c
c Now overlays
c
      ovrcol = 9
      if (ovrcolo.gt.-1) ovrcol = ovrcolo
c
c Now beams
c
      bemcol = 4
      if (bemcolo.gt.-1) bemcol = bemcolo
c
      end
c
c
