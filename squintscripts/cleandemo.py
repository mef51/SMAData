...
cgdispOptions['in'] = '../{0}/MAPSCorrect/{1}.cnt.i.{2},../{0}/MAPSCorrect/{1}.co3-2.i.{2}'.format(folders[0], sources[0], maps[1])
...
cgdispOptions['in'] = '../{0}/MAPSCorrect/{1}.cnt.i.{2},../{0}/MAPSCorrect/{1}.co3-2.i.{2}'.format(folders[0], sources[0], maps[2])
