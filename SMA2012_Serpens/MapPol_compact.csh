...
echo "Maps done with compact uv range (8,90 klambda)"
...
set dia1=120525		# DATA NEEDS IMPROVEMENTS (high amp values)
set dia2=120526
set dia3=120615
set dia4=120902
set dia5=120903
...
switch ($n)
 case 1:	# NAT 1.795x1.351, 50.2 rms=4.67(i),4.39(q),4.43(u) 
set lsbT=$vis.$dia1.lsb,$vis.$dia4.lsb,$vis.$dia5.lsb
set usbT=$vis.$dia1.usb,$vis.$dia4.usb,$vis.$dia5.usb
set mida='imsize=256 cell=0.30';set so=com
set si=0.0046; set sp=0.0044
set disp='arcsec,box(-8,-8,8,8)'
 breaksw
 case 6:	# NAT 1.804x1.350, 49.7 rms=10.2(i),4.31(q),4.47(u)
set lsbT=$vis.$dia1.lsb,$vis.$dia4.lsb,$vis.$dia5.lsb
set usbT=$vis.$dia1.usb,$vis.$dia4.usb,$vis.$dia5.usb
set mida='imsize=256 cell=0.30';set so=com
set si=0.010; set sp=0.0044
set disp='arcsec,box(-8,-8,8,8)'
 breaksw
 case 8: 	# NAT 2.068x1.716 43.3 rms=3.19(i)1.92(q)/2.15(u)
set lsbT=$vis.$dia1.lsb,$vis.$dia3.lsb
set usbT=$vis.$dia1.usb,$vis.$dia3.usb
set mida='imsize=256 cell=0.3'
set si=0.0031; set sp=0.0020
set disp='arcsec,box(-7,-6,15,16)'
 breaksw
 case 11:	# NAT 1.984x1.870, 54.8 rms=6.02(i),5.05(q),5.48(u) 
...
set disp='arcsec,box(-11,-6,8,13)'
 breaksw
 case 15:	# NAT 1.986x1.796, 50.2 rms=5.63(i),6.00(q),5.83(u)
set lsbT=$vis.$dia2.lsb
set usbT=$vis.$dia2.usb
set mida='imsize=256 cell=0.3'
...
set disp='arcsec,box(-8,-8,8,8)'
 breaksw
 case 7:	# NAT 1.991x1.836, 57.6 rms=4.72(i),5.30(q),5.02(u)
set lsbT=$vis.$dia2.lsb
set usbT=$vis.$dia2.usb
set mida='imsize=256 cell=0.3'
...
invert vis=$uv map=$map.i.mp,$map.q.mp,$map.u.mp beam=$map.bm \
       stokes=i,q,u options=double,mfs,systemp $rob $mida select=$uvs
foreach pol(i q u)
...
set nom=smc'_'$n'_cmpct_2sgm_'pol.eps
set dev="$nom/cps"
cgdisp in=$map.i.cm,$map.poli,$map.polm,$map.pa type=c,p,amp,ang \
  device="$dev" region=$disp range=0.0,0.025,lin,5 cols1=1 slev=a,0.01 \
  levs1=-6,-3,3,6,9,12,16,20,25,30,35,40,50,60,70,90,110,130,150,170 \
  options=beambl,wedge,rot90  olay=pos.serp \
  lines=2,2,7 vecfac=2.5,2,2,0.10 labtyp=hms,dms
#gv $nom &
